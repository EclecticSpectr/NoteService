...
class MainKtTest {
    ...
    fun addNote() {
        ...
        val result = service.add(Note(0, false, 111, "title1", "text1", 0, 0))
    ...
    fun getNoteByIdExist() {
        val service = NoteService()
        val note = Note(0, false, 111, "title1", "text1", 0, 0)
        service.add(note)
    ...
    fun updateNoteExist() {
        ...
        val result = service.update(Note(1, false, 111, "title1", "text1", 0, 0))
    ...
    fun updateNoteNotExist() {
        val service = NoteService()
        val result = service.update(Note(0, false, 111, "title1", "text1", 0, 0))
    ...
    fun getNotesByUserExist() {
        val service = NoteService()
        service.add(Note(0, false, 111, "title1", "text1", 0, 0))
        service.add(Note(0, false, 456, "title1", "text1", 0, 0))
        service.add(Note(0, false, 111, "title1", "text1", 0, 0))
        val result = service.get(111)?.size
    ...
    fun addComment() {
        ...
        val result = service.add(Comment(0, false, 111, 1, "message1"))
    ...
    fun updateCommentExist() {
        val service = CommentService()
        service.add(Comment(0, false, 111, 1, "message1"))
        val result = service.update(Comment(1, false, 111, 1, "message2"))
    ...
    fun updateCommentNotExist() {
        val service = CommentService()
        val result = service.update(Comment(0, false, 111, 1, "message2"))
    ...
    fun getCommentsExist() {
        val service = CommentService()
        service.add(Comment(0, false, 111, 2, "message1"))
        service.add(Comment(0, false, 456, 1, "message2"))
        service.add(Comment(0, false, 111, 1, "message3"))
